...
#if os(iOS)
    // .sleep/.appUpdate есть в iOS SDK (iOS 16+), но отсутствуют в macOS SDK (deployment target 11.0).
    // (.internalError убран — невалидный case NEProviderStopReason, его нет ни в iOS, ни в macOS SDK.)
    case .sleep:
