...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "NvoVPN"
    MACOSX_BUNDLE_BUNDLE_NAME "NvoVPN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "NvoVPN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "NvoVPN"
...
target_sources(${PROJECT} PRIVATE
    ${CMAKE_CURRENT_SOURCE_DIR}/ios/app/NvoVPNLaunchScreen.storyboard
...
# Media.xcassets — это ДИРЕКТОРИЯ: через RESOURCE нельзя (install(TARGETS) валится на каталоге).
# Кладём его в Resources через source-свойство — Xcode положит в Copy Bundle Resources,
# и actool скомпилирует AppIcon (иконки NvoVPN) в Assets.car + впишет CFBundleIcons.
set_source_files_properties(${CMAKE_CURRENT_SOURCE_DIR}/ios/app/Media.xcassets
