...
QtObject {
    property QtObject color: QtObject {
        ...
        readonly property color softGoldenApricot: Qt.rgba(102/255, 126/255, 234/255, 0.3)
        ...
        // NvoVPN: основной акцент перекрашен с apricot (#FBB26A) на бренд-индиго (nvovpn.com)
        readonly property string goldenApricotString: '#667eea'

        // NvoVPN brand palette (источник: nvovpn.com — градиент логотипа индиго→фиолет, кнопки синий→зелёный)
        readonly property color nvoGradientStart: '#667eea'
        readonly property color nvoGradientEnd: '#764ba2'
        readonly property color nvoViolet: '#8b5cf6'
        readonly property color nvoBlue: '#3b82f6'
        readonly property color nvoCyan: '#22d3ee'
        readonly property color connectedGreen: '#10b981'
        readonly property color connectedGreenDeep: '#059669'
