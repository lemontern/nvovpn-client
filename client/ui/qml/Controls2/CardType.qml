...
RadioButton {
    ...
    property string pressedBorderColor: NvoStyle.color.softGoldenApricot
    property string selectedBorderColor: NvoStyle.color.goldenApricot
    property string defaultBodredColor: NvoStyle.color.transparent
    property string focusBorderColor: NvoStyle.color.paleGray
