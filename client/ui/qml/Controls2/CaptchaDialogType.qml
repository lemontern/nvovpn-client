...
Popup {
    ...
    Overlay.modal: Rectangle {
        color: NvoStyle.color.translucentMidnightBlack
    }
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    anchors.fill: parent
                    color: NvoStyle.color.pearlGray
                    radius: 16
            ...
            TextFieldWithHeaderType {
                ...
                headerTextColor: NvoStyle.color.mutedGray

                textField.placeholderText: qsTr("_ _ _ _ _ _")
                textField.placeholderTextColor: NvoStyle.color.mutedGray
            ...
            BasicButtonType {
                ...
                borderWidth: 1
                borderColor: NvoStyle.color.mutedGray
                borderFocusedColor: NvoStyle.color.paleGray
